...
const workExperience = [
  {
    ...
    role: "Voice AI & Agentic Workflows",
    period: "2024 — Present",
    accent: "#6366F1",
    bgAccent: "bg-indigo-500",
    textAccent: "text-indigo-500",
    borderAccent: "hover:border-indigo-500/50",
    metrics: ["90→40% Flow reduction", "30%+ Revenue growth", "₹10L Q4 savings"],
    challenge:
      "Rezo's deterministic flow-builders meant 3–6 week onboarding and a 55–65% containment ceiling. Enterprise accounts were churning for LLM-native competitors (Cresta, Observe.ai, Vapi). Sales kept losing demos at the 'can it reason multi-turn?' question.",
    insight:
      "Flows can't handle non-linear conversations, but pure LLMs fail compliance. The fix: a hybrid architecture orchestrating agentic reasoning with deterministic guardrails on the compliance-critical 40%.",
    transformation: {
      before: [
        "3–6 week use-case onboarding",
        "55–65% containment rate",
        "Heavy engineering dependency for updates",
      ],
      after: [
        "~10x faster onboarding via Agentic AI",
        "30%+ bot-generated revenue growth",
        "Flow dependency reduced from 90% to 40%",
      ],
    },
    bento: [
      {
        title: "Hybrid Agentic Architecture",
        desc: "Agentic LLM orchestrator with a scoped tool registry (RAG, CRM, APIs, transactional actions) + deterministic compliance nodes for KYC, disclosures, payment confirmations.",
        span: "col-span-2",
      },
      {
        title: "Zero-Code Workflow Engine",
        desc: "0-to-1 visual canvas (15–20 node types) — non-technical ops users compose agent behaviors with sensible defaults + advanced drawer.",
        span: "col-span-1",
      },
      {
        title: "Self-Serve MCP Analytics",
        desc: "Conversational analytics on MCP server infra. ~20 scoped tools replacing 5-day SQL cycles. ~70% drop in CS reporting tickets.",
        span: "col-span-1",
      },
      {
        title: "Eval & Guardrails",
        desc: "Golden dataset of ~2,000 labeled conversations. PII redaction, profanity filters, tenant-scoped tool permissions, regression gating before every promotion.",
        span: "col-span-2",
      },
    ],
  },
  {
    ...
    metrics: ["54% Faster TAT", "20% Accuracy gain", "75% Faster APIs"],
    challenge:
      "Traditional OCR failed on 40% of documents (handwriting, low-res mobile scans, partial occlusions). Accuracy dropped to 65–70%, creating 24–48hr human review backlogs. A major enterprise client had escalated, threatening contract renegotiation.",
    insight:
      "Wholesale GPT-Vision replacement was too expensive. The underutilized OCR confidence scores plus image-quality signals were enough to route selectively — keep the 60% easy cases on OCR, escalate ambiguous ones to GPT-Vision, humans only at the tail.",
    transformation: {
      before: [
        "65–70% accuracy on messy documents",
        "24–48hr human review queue backlog",
        "Client escalation on missed SLAs",
      ],
      after: [
        "Confidence-based hybrid AI routing",
        "~60% smaller review queue",
        "Per-doc-type GPT-Vision prompts deployed",
      ],
    },
    bento: [
      {
        title: "Confidence Router",
        desc: "OCR confidence + image quality + structural cues route docs: high → auto-accept, mid → GPT-Vision, low → human with both outputs shown.",
        span: "col-span-2",
      },
      {
        title: "Per-Doc Prompt Schemas",
        desc: "Strict JSON schemas tuned per doc type (PAN, passport, bank statement, utility bill) with graceful malformed-output fallback.",
        span: "col-span-1",
      },
      {
        title: "Swagger API Auto-Gen",
        desc: "Auto-generated wrapper code, test cases, and docs from OpenAPI specs. Per-API integration time down 75%.",
        span: "col-span-1",
      },
      {
        title: "GROQ Support Automation",
        desc: "Two-part: error-message translation + KB-backed first-level resolver. 28% drop in repeat tickets to engineering; RCA shortened by ~60 minutes.",
        span: "col-span-2",
      },
    ],
  },
  {
    ...
    role: "FinTech APIs & Identity",
    period: "2022 — 2024",
    accent: "#F59E0B",
    bgAccent: "bg-amber-500",
    textAccent: "text-amber-500",
    borderAccent: "hover:border-amber-500/50",
    metrics: ["₹1.5Cr/mo TPV", "21% Less drop-off", "32% Auto-closure"],
    challenge:
      "140+ legacy verification APIs causing versioning chaos with p99 latencies hitting 10s+. Mid-tier NBFCs spent 7+ days collecting statements because Account Aggregator integration was too costly. ~40 FTEs doing manual employment verification at ₹10L/month.",
    insight:
      "Segment by ticket size × tech maturity. Target mid-tier NBFCs (₹50K–5L loans) with a turnkey AA wrapper; codify the allocation heuristic ops coordinators already ran in their heads; automate the HR-language-judgment work with LLM sentiment classification.",
    transformation: {
      before: [
        "No Account Aggregator integration",
        "Top APIs hitting 10s+ latency at p99",
        "~40 FTEs doing manual verification",
      ],
      after: [
        "AA live — driving ₹1.5 Cr/mo TPV",
        "Top 20 APIs optimized to < 3s at p95",
        "32% auto-closure via LLM sentiment analysis",
      ],
    },
    bento: [
      {
        title: "Account Aggregator APIs",
        desc: "Consent management built to ReBIT specs behind a clean REST surface. Targeted mid-tier NBFC segment → ₹1.5Cr/mo TPV in first launch cycle; ₹50L/mo revenue uplift in two quarters.",
        span: "col-span-2",
      },
      {
        title: "Video KYC Edge AI",
        desc: "Real-time edge detection + auto-capture, queue transparency with countdown, plain-language consent (legal-approved). Drop-off reduced 21% relative across 25+ field-audit-driven interventions.",
        span: "col-span-1",
      },
      {
        title: "OPUS — Vendor Allocation",
        desc: "Multi-factor scoring (geo fit, load, response time, quality, SLA risk) → ~95% allocation automation. Replaced tribal-knowledge manual assignment.",
        span: "col-span-1",
      },
      {
        title: "Field Agent Mobile App",
        desc: "Route-optimized daily allocation, step-by-step in-field capture guidance, real-time upload, offline sync. Cut QC rejections caused by incomplete capture.",
        span: "col-span-2",
      },
      {
        title: "Employment Verification LLM",
        desc: "LLM-generated outbound emails + sentiment classification on qualitative HR fields. 32% auto-closure; ~40 FTEs (~₹10L/mo) of work automated.",
        span: "col-span-1",
      },
      {
        title: "Data Quality Engine",
        desc: "Fuzzy name matching + MCA/GST collation + email-history tracing. 100K+ records cleaned, 20K+ duplicates eliminated — the data foundation for verification automation.",
        span: "col-span-1",
      },
      {
        title: "140+ API Lifecycle Ownership",
        desc: "Owned the full microservice surface. Top 20 endpoints optimized to sub-3s p95, formal versioning policy, biweekly API council. Release velocity up ~30%.",
        span: "col-span-2",
      },
      {
        title: "Bridge Workflow Automation",
        desc: "Umbrella program: RPA + OCR + email automation + data cleanup. 26% reduction in manual operational dependency, 12% fewer systemic errors.",
        span: "col-span-2",
      },
    ],
  },
      ...
      >
        ...
        <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 mb-8">
          <div className="flex items-center gap-5">
            <cs.logo />
            <div>
              <h3 className={`font-serif text-3xl md:text-4xl mb-1 ${tc("text", theme)}`}>
                {cs.company}
              </h3>
          ...
          <div className="flex items-center gap-3">
            <span className={`text-xs hidden md:block ${tc("textSubtle", theme)}`}>{cs.period}</span>
            <div
              className={`w-8 h-8 rounded-full border ${tc("border", theme)} flex items-center justify-center -rotate-45 group-hover:rotate-0 transition-transform duration-500 ${tc("textMuted", theme)}`}
            >
        ...
        <div className={`grid grid-cols-1 md:grid-cols-2 gap-6 pt-6 border-t ${tc("borderSoft", theme)}`}>
          <div>
            <p className={`text-[10px] font-bold uppercase tracking-widest mb-3 ${tc("textFaint", theme)}`}>
              Before
            </p>
            <ul className="space-y-2">
              {cs.transformation.before.map((point, i) => (
                <li
                  key={i}
                  className={`flex items-start gap-2 text-sm line-through decoration-red-500/30 ${
                    theme === "dark" ? "text-zinc-500" : "text-zinc-500"
                  }`}
                >
                  <span className="text-red-500/60 mt-0.5">✕</span> {point}
                </li>
              ))}
            </ul>
          </div>
          <div>
            <p className={`text-[10px] font-bold uppercase tracking-widest ${cs.textAccent} mb-3`}>
              After
            </p>
            <ul className="space-y-2">
              {cs.transformation.after.map((point, i) => (
                <li
                  key={i}
                  className={`flex items-start gap-2 text-sm font-medium ${tc("text", theme)}`}
                >
                  <span className={`${cs.textAccent} mt-0.5`}>✓</span> {point}
                </li>
              ))}
            </ul>
          </div>
...
const CaseStudyView: React.FC<{
  ...
  const fromCase = caseStudies.find((c) => c.id === id);
  const fromWork = workExperience.find((w) => w.id === id);
  const loaded = useReveal(60);

  if (!fromCase && !fromWork) return null;

  // Normalize into a single shape the view can render.
  const cs = fromCase
    ? {
        title: fromCase.title,
        subtitle: fromCase.subtitle,
        company: fromCase.company,
        tag: fromCase.tag,
        metrics: fromCase.metrics,
        challenge: fromCase.sections.challenge,
        insight: fromCase.sections.insight,
        transformation: fromCase.sections.transformation,
        bento: fromCase.sections.bento,
        accent: fromCase.accent,
        bgAccent: fromCase.bgAccent,
      }
    : {
        title: fromWork!.company,
        subtitle: fromWork!.role,
        company: fromWork!.company,
        tag: "Experience",
        metrics: fromWork!.metrics,
        challenge: fromWork!.challenge,
        insight: fromWork!.insight,
        transformation: fromWork!.transformation,
        bento: fromWork!.bento,
        accent: fromWork!.accent,
        bgAccent: fromWork!.bgAccent,
      };
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="bg-white border border-zinc-200 rounded-2xl p-6">
                ...
                <ul className="space-y-2.5">
                  {cs.transformation.before.map((p, i) => (
              ...
              <div className="bg-white border border-zinc-200 rounded-2xl p-6">
                ...
                <ul className="space-y-2.5">
                  {cs.transformation.after.map((p, i) => (
